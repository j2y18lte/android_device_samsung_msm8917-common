...
#PRODUCT_COPY_FILES += \
#    $(LOCAL_PATH)/rootdir/etc/init.save_boot_logs.rc:system/vendor/etc/init/hw/init.save_boot_logs.rc \
#    $(LOCAL_PATH)/rootdir/etc/save_boot_logs.sh:system/bin/save_boot_logs.sh
