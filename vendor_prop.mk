PRODUCT_PROPERTY_OVERRIDES += \
    ...
    persist.vendor.camera.zsl.mode=0 \
    persist.camera.zsl.disabled=1 \
    persist.vendor.camera.zsl.disabled=1 \
    persist.camera.ois.disable=1 \
    persist.vendor.camera.ois.disable=1 \
    persist.camera.longshot.stages=0 \
    persist.vendor.camera.longshot.stages=0
